...
@Component({
  selector: 'app-gm-info-details',
  templateUrl: './gm-info-details.component.html',
  styleUrls: ['./gm-info-details.component.scss']
})
export class GmInfoDetailsComponent implements OnInit {
  userId: string;
  // Default value
  ...
  public getGmInfoFromChild(userInfo: UserProfile) {
