...
@Component({
  selector: 'app-gm-tab-revenue',
  templateUrl: './gm-tab-revenue.component.html',
  styleUrls: ['./gm-tab-revenue.component.scss']
})
export class GmTabRevenueComponent implements OnInit {
  @Input() userId: string;
  // List
  ...
  public getPtRevenueByMonth(options?: Query) {
    ...
    this.employeeSvc
      .getGmRevenueById(this.userId, omitBy(options, isNil))
      .subscribe((res: any) => {
        ...
        this.listPtRevenueByMonth = res.data.groups;
        this.spinner.hide();
      }, () => this.spinner.hide());
  }
  ...
  public getPtRevenueByQuarter(options?: Query) {
    ...
    this.employeeSvc
      ...
      .subscribe((res: any) => {
        ...
        this.totalRevenueQuarter = res.data.revenue;
        this.listPtRevenueByQuarter = res.data.groups;
        this.spinner.hide();
      }, () => this.spinner.hide());
  }
}
